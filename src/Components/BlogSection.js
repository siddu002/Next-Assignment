...
const BlogSection = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <Image className="lg:h-64 md:h-48 w-full object-cover object-center" src={water} alt="blog"/>
    <div className="p-6">
    ...
    <div className="flex items-center mb-2">
        <Image src={alce} className="w-10 h-10 rounded-full mr-2" alt="user-avatar"/> 
    ...
    <span className="text-gray-500 text-xs ml-[45px] -mt-5">June 1, 2024</span> 
     ...
     <div className="p-4 md:w-1/3">
     <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
    <Image className="lg:h-64 md:h-48 w-full object-cover object-center" src={person} alt="blog"/>
    <div className="p-6">
        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
        <h1 className="title-font text-lg font-medium text-gray-900 mb-3">The Catalyzer</h1>
        <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
    ...
    <span className="text-gray-500 text-xs ml-[45px] -mt-5">June 1, 2024</span> 
      ...
      <div className="p-4 md:w-1/3">
      <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
    <Image className="lg:h-64 md:h-48 w-full object-cover object-center" src={steel} alt="blog"/>
    <div className="p-6">
        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
        <h1 className="title-font text-lg font-medium text-gray-900 mb-3">The Catalyzer</h1>
        <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
