    ...
    <div className="container mx-auto p-6 text-center overflow-hidden">
      <header className="mb-12">
        <div className="mb-4 text-purple-700 inline-flex items-center border border-purple-700 rounded-full">
          <span className="inline-block bg-purple-100 px-3 py-1 rounded-full text-[8px] md:text-sm">
            New feature
          </span>
          <a
            href="#"
            className="ml-2 text-purple-700 no-underline mr-2 text-center text-xs md:text-sm"
          >
        ...
        <div className="mx-auto lg:w-[1280px]">
          ...
          <div className="flex flex-wrap justify-center lg:justify-between items-center mx-auto">
            <Image
              src={oneimg}
              alt="Logo 1"
              className="w-[127px] h-[36px] lg:w-[170px] lg:h-[48px] m-2"
            />
            <Image
              src={twoimg}
              alt="Logo 2"
